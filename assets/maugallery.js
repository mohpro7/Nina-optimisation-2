(function($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    prevImage() {
      console.log("Début de la fonction prevImage");
      let activeImage = null;
      $("img.gallery-item").each(function() {
        if ($(this).attr("src") === $(".lightboxImage").attr("src")) {
          activeImage = $(this);
          console.log("Image active trouvée:", $(this).attr("src"));
        }
      });
      ...
      console.log("Collection d'images:", imagesCollection.map(img => $(img).attr("src")));
      let index = 0,
        next = null;
    ...
    nextImage() {
      console.log("Début de la fonction nextImage");
      let activeImage = null;
      $("img.gallery-item").each(function() {
        if ($(this).attr("src") === $(".lightboxImage").attr("src")) {
          activeImage = $(this);
